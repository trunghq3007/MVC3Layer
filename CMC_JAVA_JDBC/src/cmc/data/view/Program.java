...
public class Program {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		/*
		 * Student student = new Student(); student.setStudentId(100);
		 * student.setFullName("abc"); student.setAge(20); student.setAddress("add");
		 */
		// them moi student
		// studentBUS.insert(student);
		/*
		 * list = studentBUS.getAllStudent(); studentBUS.showStudentList(list);
		 */
